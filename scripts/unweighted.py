...
# read in by region
df_vels_full = pd.read_csv(procdir + "full_disk_vels_unweighted.csv")
plage = pd.read_csv(procdir + "plage_vels_unw.csv")
network = pd.read_csv(procdir + "network_vels_unw.csv")
quiet_sun = pd.read_csv(procdir + "quiet_sun_vels_unw.csv")
quiet_sun2 = pd.read_csv(procdir + "quiet_sun_vels.csv")
penumbrae = pd.read_csv(procdir + "penumbrae_vels_unw.csv")
red_penumbrae = pd.read_csv(procdir + "red_penumbrae_vels_unw.csv")
blu_penumbrae = pd.read_csv(procdir + "blu_penumbrae_vels_unw.csv")
umbrae = pd.read_csv(procdir + "umbrae_vels_unw.csv")
...
clv_plot("v_hat", "unw_fig4a.pdf")
clv_plot("v_conv", "unw_fig4b.pdf")
...
fig.savefig(plotdir + "unw_fig5a.pdf")
plt.clf(); plt.close()
...
axs[0].set_ylabel(r"${\rm Probability\ Density}$")
axs[-1].legend(fontsize=10)
fig.savefig(plotdir + "unw_fig5b.pdf")
plt.clf(); plt.close()
...
axs[0].set_ylabel(r"${\rm Probability\ Density}$")
axs[-1].legend(fontsize=10)
fig.savefig(plotdir + "unw_fig5c.pdf")
plt.clf(); plt.close()
...
axs[0].set_ylabel(r"${\rm Probability\ Density}$")
axs[-1].legend(fontsize=10)
fig.savefig(plotdir + "unw_fig6a.pdf")
plt.clf(); plt.close()
...
axs[0].set_ylabel(r"${\rm Probability\ Density}$")
axs[-1].legend(fontsize=10)
fig.savefig(plotdir + "unw_fig6b.pdf")
plt.clf(); plt.close()
